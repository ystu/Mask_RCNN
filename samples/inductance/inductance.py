...
# ROOT_DIR = os.path.abspath("D:/github/Mask_RCNN")
...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):
        ...
        for i in range(count):
            ...
            yaml_path = dataset_root_path + "/dataset/" + filestr + "/info.yaml"
            print(dataset_root_path + "/dataset/" + filestr + "/img.png")
            cv_img = cv2.imread(dataset_root_path + "/dataset/" + filestr + "/img.png")
